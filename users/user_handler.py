...
class SignUpHandler(EH.EnhancedHandler):
    ...
    def post(self):
        ...
        self.user_name = self.request.get('user_name_signup_name')
        self.password = self.request.get('password_signup_name')
        self.verify = self.request.get('password_match_signup_name')
        self.email = self.request.get('email_signup_name')
...
class LoginHandler(EH.EnhancedHandler):
    ...
    def post(self):
        self.user_name = self.request.get('user_name_login_name')
        self.password = self.request.get('password_login_name')
