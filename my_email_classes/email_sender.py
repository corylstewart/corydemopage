...
class SendEmail:
    ...
    def construct_attachments(self, attachments):
        self.attachments = []
...
class AdminAlertEmail:
    ...
    def send_new_picture_upload(self):
    ...
    def send_email(self):
        email = SendEmail(self.recipient_name, self.recipient_email, self.subject, self.body)
        email.send_email()